...
public class AmaranteLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SPACE", "COMMENT", "Comillas", "T_dato", "Cadena", "If", "Else", "Do", 
			"While", "For", "Igual", "Suma", "Resta", "Multiplicacion", "Division", 
	...
	public AmaranteLexer(CharStream input) {
		super(input);
